...
**What does not exist is Hire** — no worktree, no role session, no board tab. The loop and its
eight unbuilt steps are on [the site](https://dkpanseriya.github.io/deckhq/studio.html).
