  ...
  if (flag('--help') || flag('-h')) {
    process.stdout.write(
      [
        ...
        '                address bar. WP-62. `--dry-run` prints what it would start',
        '                and open, and starts nothing. On its first window it offers',
        '                once to put DeckHQ on your Desktop and Start Menu.',
