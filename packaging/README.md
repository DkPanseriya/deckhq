...
| `floor.png`, `panel-review-card.png`, `hero.gif`                                                       | The floor, the review card and the hero animation, from `docs/media/` | They are there for the release page. `panel.png` is the panel before WP-08 and is no longer attached.                                                                                                                                                                                   |
