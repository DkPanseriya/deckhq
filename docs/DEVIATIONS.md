...
## 94. WP-19 build — the panel can answer a permission prompt, and the run that proves it has not happened
...
### 94.2 The five things it will never do, and where each is nailed down
...
### 94.3 Nine decisions this build took that §86 left open
...
### 94.4 Codex is not built, and here is the route when it is
...
### 94.5 What proves what, and what is still owed
