...
## 114. WP-57 — the seven seams, and the two rules that decided each one
...
### 114.1 The room plate's third line — §111's RAISE
...
### 114.2 The project board's cost — §111's `|| 0`
...
### 114.3 The hover card's record line — §107's DECISION NEEDED
...
### 114.4 `P` folds into the keyboard map — §113.5
...
### 114.5 The deny message — §97.3 decision 1
...
### 114.6 Five more tool summaries — §89's accepted limits
...
### 114.7 The coach marks already point at the right things — §108.1
