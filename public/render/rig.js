...
const BUBBLE_MAX_W_U = 9;
const BUBBLE_MAX_W_PX = 150;
const BUBBLE_MIN_W_PX = 44;
 ...
 * @param {string} summary
 */
function drawToolBubble(ctx, ox, oy, u, summary) {
 ...
 */
function drawToolIcon(ctx, ox, oy, u, kind) {
